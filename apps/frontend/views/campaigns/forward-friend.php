        ...
        <div class="box box-primary">
            ...
            <div class="box-footer">
                <div class="pull-right">
                    <button type="submit" class="btn btn-primary btn-submit" data-loading-text="<?php echo Yii::t('app', 'Please wait, processing...');?>"><?php echo Yii::t('campaigns', 'Forward to a friend');?></button>
                </div>
                <div class="clearfix"><!-- --></div>
            </div>
        </div>
