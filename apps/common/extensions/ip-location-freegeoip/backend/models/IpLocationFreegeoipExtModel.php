...
class IpLocationFreegeoipExtModel extends FormModel
{
    ...
    {
        $labels = array(
            'status_on_email_open'  => Yii::t('ext_ip_location_freegeoip', 'Status on email open'),
            'status_on_track_url'   => Yii::t('ext_ip_location_freegeoip', 'Status on track url'),
            'status_on_unsubscribe' => Yii::t('ext_ip_location_freegeoip', 'Status on unsubscribe'),
            'sort_order'            => Yii::t('ext_ip_location_freegeoip', 'Sort order'),
        );
    ...
    {
        $texts = array(
            'status'                => Yii::t('ext_ip_location_freegeoip', 'Whether this service is enabled and can be used'),
            'status_on_email_open'  => Yii::t('ext_ip_location_freegeoip', 'Whether to collect ip location information when a campaign email is opened'),
            'status_on_track_url'   => Yii::t('ext_ip_location_freegeoip', 'Whether to collect ip location information when a campaign link is clicked and tracked'),
            'status_on_unsubscribe' => Yii::t('ext_ip_location_freegeoip', 'Whether to collect ip location information when a subscriber unsubscribes via a campaign'),
            'sort_order'            => Yii::t('ext_ip_location_freegeoip', 'If multiple location services active, sort order decides which one queries first'),
        );
