...
<div class="col-lg-12" id="activity-map-container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="map" data-translate='{"email":"<?php echo CHtml::encode(Yii::t('campaign_reports', 'Email'));?>", "date":"<?php echo CHtml::encode(Yii::t('campaign_reports', 'Date'));?>", "ip":"<?php echo CHtml::encode(Yii::t('campaign_reports', 'Ip address'));?>", "device":"<?php echo CHtml::encode(Yii::t('campaign_reports', 'Device'));?>"}'></div>
            <div class="clearfix"><!-- --></div>
        </div>
