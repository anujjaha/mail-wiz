...
class OptionCronProcessDeliveryBounce extends FormModel
{
    ...
    {
        $rules = array(
            array('process_at_once, max_fatal_errors, max_soft_errors, max_hard_bounce, max_soft_bounce', 'required'),
            ...
            array('process_at_once', 'numerical', 'min' => 50, 'max' => 500),
            array('max_fatal_errors, max_hard_bounce', 'numerical', 'min' => 1, 'max' => 1000),
            array('max_soft_errors, max_soft_bounce', 'numerical', 'min' => 1, 'max' => 1000),
        );
    ...
    public function attributeHelpTexts()
    {
        $texts = array(
            ...
            'process_at_once'   => Yii::t('settings', 'How many logs to process at once. Please note that this number is will be 4 times higher on the server.'),
