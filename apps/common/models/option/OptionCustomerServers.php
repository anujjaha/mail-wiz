...
class OptionCustomerServers extends OptionBase
{
    ...
    {
        $rules = array(
            array('max_delivery_servers, max_bounce_servers, max_fbl_servers, must_add_bounce_server, can_select_delivery_servers_for_campaign, can_send_from_system_servers', 'required'),
            ...
            array('max_delivery_servers, max_bounce_servers, max_fbl_servers', 'numerical', 'integerOnly' => true, 'min' => -1, 'max' => 100),
            array('allowed_server_types', 'safe'),
        );
