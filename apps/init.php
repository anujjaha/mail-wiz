...
// support forum.
defined('MW_SUPPORT_FORUM_URL') or define('MW_SUPPORT_FORUM_URL', 'http://nullrefer.com/?https://forum.mailwizz.com/');
...
// since 1.3.4.8 if php >= 5.3 make use of composer where needed
