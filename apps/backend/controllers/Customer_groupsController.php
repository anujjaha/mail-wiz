...
class Customer_groupsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($group->modelName, array()))) {
            ...
            try {
                ...
                $models = array($common, $servers, $trackingDomains, $sendingDomains, $lists, $campaigns, $quotaCounters, $sending, $cdn);
    ...
    {
        if (!in_array($event->params['attribute'], array('email_footer', 'notification_message'))) {
            return;
        }
