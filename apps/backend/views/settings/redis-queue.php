...
if ($viewCollection->renderContent) {
    $this->renderPartial('_queue_tabs');
    /**
    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><?php echo Yii::t('settings', 'Redis queue')?></h3>
            </div>
            <div class="box-body">
                <?php 
                /**
                ...
                <div class="form-group col-lg-3">
                    ...
                    <?php echo $form->textField($model, 'hostname', $model->getHtmlOptions('hostname')); ?>
                ...
                <div class="form-group col-lg-3">
                    ...
                    <?php echo $form->textField($model, 'database', $model->getHtmlOptions('database')); ?>
