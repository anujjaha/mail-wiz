    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><?php echo Yii::t('settings', 'System urls')?></h3>
            </div>
            <div class="box-body">
            ...
            <div class="box-footer">
                <div class="pull-right">
                    <button type="submit" class="btn btn-primary btn-submit" data-loading-text="<?php echo Yii::t('app', 'Please wait, processing...');?>"><?php echo Yii::t('settings', 'Regenerate urls');?></button>
                </div>
                <div class="clearfix"><!-- --></div>
            </div>
        </div>
