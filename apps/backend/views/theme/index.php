        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                if (AccessHelper::hasRouteAccess('theme/upload')) {
                    echo CHtml::link(Yii::t('themes', 'Upload theme'), '#theme-upload-modal', array('class' => 'btn btn-primary btn-xs', 'data-toggle' => 'modal', 'title' => Yii::t('themes', 'Upload theme')));
                }
                ?>
                <?php echo HtmlHelper::accessLink(Yii::t('app', 'Refresh'), array('theme/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
