...
<div class="box box-primary">
    ...
    <div class="box-footer">
        <div class="pull-right">
            <a href="<?php echo $this->createUrl('sending_domains/verify', array('id' => $domain->domain_id));?>" class="btn btn-primary btn-submit" data-loading-text="<?php echo Yii::t('app', 'Please wait, processing...');?>"><?php echo Yii::t('sending_domains', 'Verify DNS records');?></a>
        </div>
