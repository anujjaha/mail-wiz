        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="pull-right">
                    ...
                    <?php echo CHtml::link(Yii::t('app', 'Create new'), array('languages/create'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Create new')));?>
                    <?php } ?>
                    <?php echo CHtml::link(Yii::t('app', 'Cancel'), array('languages/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Cancel')));?>
                </div>
