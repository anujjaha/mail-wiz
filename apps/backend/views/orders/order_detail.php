    ...
    <div class="row no-print">
        <div class="col-xs-12">
            <div class="pull-right">
                ...
                <a href="<?php echo $this->createUrl('orders/email_invoice', array('id' => $order->order_id));?>" class="btn btn-success"><i class="fa fa-envelope"></i> <?php echo Yii::t('orders', 'Email invoice');?></a>
                <a target="_blank" href="<?php echo $this->createUrl('orders/pdf', array('id' => $order->order_id));?>" class="btn btn-success"><i class="fa fa-clipboard"></i> <?php echo Yii::t('orders', 'View invoice');?></a>
                <a href="<?php echo $this->createUrl('orders/update', array('id' => $order->order_id));?>" class="btn btn-primary"><?php echo Yii::t('orders', 'Update this order');?></a>
                <a href="<?php echo $this->createUrl('orders/index');?>" class="btn btn-primary"><?php echo Yii::t('orders', 'Back to orders');?></a>    
            </div>
        </div>
    </div>
</div>
