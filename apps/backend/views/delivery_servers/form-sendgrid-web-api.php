...
if ($viewCollection->renderContent) {
    ...
    if ($collection->renderForm) {
        ...
        <div class="callout callout-info">
            <?php echo Yii::t('servers', 'Please note that automatic events handling, such as bounces or complaints, is done only if your Sendgrid account is free or at least Bronze.');?><br />
            <?php echo Yii::t('servers', 'If you later upgrade to a Bronze account, you will have to delete this delivery server and add it again for automatic handling of events.');?>
        </div>
