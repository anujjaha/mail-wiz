...
/**
 * FieldBuilderTypeDateSubscriber
 * 
...
class FieldBuilderTypeDateSubscriber extends CBehavior
{
    // register at init
    public function attach($owner)
    {
        ...
        if (Yii::app()->apps->isAppName('frontend')) {
            ...
            Yii::app()->clientScript->registerScript(md5(__FILE__ . __LINE__), '
    ...
    public function _setCorrectValidationRules(CModelEvent $event)
    {
        ...
        $rules->add(array('value', 'length', 'is' => 10));
        $rules->add(array('value', 'date', 'format'=>'yyyy-MM-dd'));
    }
