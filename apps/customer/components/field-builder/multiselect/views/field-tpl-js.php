    ...
    <div class="field-row" data-start-index="{index}" data-field-type="<?php echo $fieldType->identifier;?>">
        ...
        <div class="panel panel-default no-top-border">
            ...
            <div class="panel-body">
                ...
                <div class="clearfix"><!-- --></div>
                <hr />
                <h4><?php echo Yii::t('list_fields', 'Dropdown options');?> <a href="javascript:;" class="btn btn-xs btn-primary pull-right btn-multiselect-add-option"><?php echo Yii::t('list_fields', 'Add new')?></a></h4>
                <div class="clearfix"><!-- --></div>
                <hr />
            ...
            <div class="panel-footer">
                <div class="pull-right">
                    <a href="javascript:;" class="btn btn-danger btn-xs btn-remove-multiselect-field" data-field-id="0" data-message="<?php echo Yii::t('list_fields', 'Are you sure you want to remove this field? There is no coming back from this after you save the changes.');?>"><?php echo Yii::t('app', 'Remove');?></a>
                </div>
                <div class="clearfix"><!-- --></div>
            </div>    
...
<div id="field-multiselect-option-javascript-template" style="display: none;">
    <div class="form-group col-lg-6 multiselect-option-row" data-start-index="{optionIndex}" data-parent-index="{parentIndex}">
        ...
        <div class="form-group col-lg-2">
            <div class="pull-left" style="margin-top: 30px;">
                <a href="javascript:;" class="btn btn-danger btn-xs btn-remove-multiselect-option-field" data-option-id="0" data-message="<?php echo Yii::t('list_fields', 'Are you sure you want to remove this option? There is no coming back from this after you save the changes.');?>"><?php echo Yii::t('app', 'Remove');?></a>
            </div>
        </div>
        <div class="clearfix"><!-- --></div>
    </div>
