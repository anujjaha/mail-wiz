...
/**
 * FieldBuilderTypeDropdownSubscriber
 * 
...
class FieldBuilderTypeDropdownSubscriber extends CBehavior
{
    ...
    protected function buildFieldArray($model)
    {
        ...
        if ($field->visibility == ListField::VISIBILITY_VISIBLE || Yii::app()->apps->isAppName('customer')) {
            $fieldHtml = $this->owner->renderInternal($viewFile, compact('model', 'field', 'options'), true);
        }
