    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
            	...
            	<?php echo CHtml::link(Yii::t('app', 'Refresh'), array('campaign_reports/abuse_reports', 'campaign_uid' => $campaign->campaign_uid), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
    		</div>
