...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo CHtml::link(Yii::t('app', 'Create new'), array('feedback_loop_servers/create'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Create new')));?>
                <?php echo CHtml::link(Yii::t('app', 'Refresh'), array('feedback_loop_servers/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
    ...
    <div class="callout callout-info">
        <?php 
        $text = 'Please note, when adding a feedback server make sure the email address is used only for reading feedback email but nothing more.<br />
        This is important since the script that checks the feedback emails needs to read all the emails from the account you specify and will delete them all after processing.';
