    ...
    <div class="row no-print">
        <div class="col-xs-12">
            <div class="pull-right">
                ...
                <a href="<?php echo $this->createUrl('price_plans/email_invoice', array('order_uid' => $order->order_uid));?>" class="btn btn-success"><i class="fa fa-envelope"></i> <?php echo Yii::t('orders', 'Email invoice');?></a>
                <a target="_blank" href="<?php echo $this->createUrl('price_plans/order_pdf', array('order_uid' => $order->order_uid));?>" class="btn btn-success"><i class="fa fa-clipboard"></i> <?php echo Yii::t('orders', 'View invoice');?></a>
                <a href="<?php echo $this->createUrl('price_plans/orders');?>" class="btn btn-primary"><?php echo Yii::t('orders', 'Back to orders');?></a>    
            </div>
        </div>
    </div>
</div>
