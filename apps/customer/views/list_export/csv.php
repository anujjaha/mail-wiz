...
<div class="box box-primary">
    <div class="box-header">
        ...
        <div class="pull-right">
            <?php echo CHtml::link(Yii::t('list_export', 'Back to export options'), array('list_export/index', 'list_uid' => $list->list_uid), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Back')));?>
        </div>
