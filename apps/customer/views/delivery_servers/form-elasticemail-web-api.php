...
if ($viewCollection->renderContent) {
    ...
    if ($collection->renderForm) {
        ...
        <div class="callout callout-info">
            <?php echo Yii::t('servers', 'The url where this server expects to receive webhooks requests to process bounces and complaints is: {url}', array('{url}' => sprintf('<strong>%s</strong>', Yii::app()->apps->getAppUrl('frontend', 'dswh/' . $server->server_id, true))));?><br />
            <?php echo Yii::t('servers', 'You can configure your ElasticEmail account from: {url}', array(
                '{url}' => CHtml::link('https://elasticemail.com/account#/account/advancedoptions', 'https://elasticemail.com/account#/account/advancedoptions', array('target' => '_blank')),
            ));?><br />
            <?php echo Yii::t('servers', 'Make sure you disable click/opens tracking and you configure the HTTP Web Notifications properly including the above webhook url.');?>
        </div>
        <?php } ?>
