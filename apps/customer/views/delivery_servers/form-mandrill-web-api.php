    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-lg-4">
                    <?php echo $form->labelEx($server, 'subaccount');?>
                    <?php echo $form->textField($server, 'subaccount', $server->getHtmlOptions('subaccount')); ?>
                    <?php echo $form->error($server, 'subaccount');?>
                </div>
                <div class="clearfix"><!-- --></div>
                <div class="form-group col-lg-4">
