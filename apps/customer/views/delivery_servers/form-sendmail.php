    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-lg-3">
                    <?php echo $form->labelEx($server, 'sendmail_path');?>
                    <?php echo $form->textField($server, 'sendmail_path', $server->getHtmlOptions('sendmail_path')); ?>
                    <?php echo $form->error($server, 'sendmail_path');?>
                </div>
                <div class="form-group col-lg-3">
