...
jQuery(document).ready(function($){
    ...
    var _koHandlersInit = function(){
        ...
        var glance = function(){
            ...
            self.deliveryServers    = ko.observable(0);
        ...
        var chatter = function(){
            ...
            self.removeAll = function() {
                if (!confirm($('#chatter-remove-all').data('confirm'))) {
        			return false;
        		}
                self.loading(true);
